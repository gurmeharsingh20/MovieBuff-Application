...
class NowPlaying : AppCompatActivity() , MovieItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Now-Playing Movies"
//        supportActionBar?.setDisplayHomeAsUpEnabled(true)
    ...
    private fun fetchData(){
        val url = "https://api.themoviedb.org/3/movie/now_playing?api_key=58e390a09e3b507cd178131442e07b16"
